...
public class ConfirmTwenties extends JFrame implements ActionListener {
    ...
    ConfirmTwenties() {
        this.label = new JLabel("You have chosen " + Twenties.numTwenties + " twenties. Is this correct?");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == this.yes) {
            WelcomePage.withdrawAmount -= (double)(Twenties.numTwenties * 20);
            if (Double.compare(WelcomePage.withdrawAmount, 10.0) >= 0) {
                this.frame.dispose();
                new Tens();
