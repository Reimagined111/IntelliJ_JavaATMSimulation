...
public class ConfirmFives extends JFrame implements ActionListener {
    ...
    ConfirmFives() {
        this.label = new JLabel("You have chosen " + Fives.numFives + " fives. Is this correct?");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == this.yes) {
            WelcomePage.withdrawAmount -= (double)(Fives.numFives * 5);
            if (Double.compare(WelcomePage.withdrawAmount, 1.0) >= 0) {
                this.frame.dispose();
                new Ones();
            } else {
                this.frame.dispose();
